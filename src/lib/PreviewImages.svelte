<script lang="ts">
  import carImage from "$lib/assets/porsche.png";
  import valleyImage from "$lib/assets/valley.png";
  import puppyImage from "$lib/assets/dog.png";
  import pastaImage from "$lib/assets/burger.png";
  import abstractImage from "$lib/assets/sunset.png";
